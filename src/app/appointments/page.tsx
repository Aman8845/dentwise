  ...
  return (
    <>
      ...
      <div className="max-w-7xl mx-auto px-6 py-8 pt-24">
        {/* header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Bool an Appointment</h1>
        ...
        {currentStep === 2 && selectedDentistId && <TimeSelectionStep  selectedDentistId={selectedDentistId}
        ...
        {currentStep === 3 && selectedDentistId && <BookingConfirmationStep   selectedDentistId={selectedDentistId}
            selectedDate={selectedDate}
            selectedTime={selectedTime}
            selectedType={selectedType}
